...
export default function Home() {
  ...
  return (
    <div className="p-0 bg-[#eaf1ff] min-h-screen text-[#1A2130] mt-32">
      <div className="flex bg-white rounded-t-lg p-4 font-semibold">
        <button
      ...
      <div className="table-cont bg-white rounded-lg">
